 ...
 */
public class DeficiencyClearOperatorCommandBB extends ClearOperatorCommand {
	...
	public CommandResult execute(CommandContext cc) throws BLException {
		...
		if (isDeficencyManagerL1) {
			clearAttributes(cc, deficiencyManagerL1Attributes);
		} else if (isDeficencyManagerL2) {
			clearAttributes(cc, deficiencyManagerL2Attributes);
		} else if (isDeficencyManagerL3) {
			clearAttributes(cc, deficiencyManagerL3Attributes);
		} else {
